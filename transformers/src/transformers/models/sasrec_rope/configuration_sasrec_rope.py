...
__all__ = ["SasrecRoPEConfig"]

logger = logging.get_logger(__name__)


class SasrecRoPEConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a [`SasrecRoPEModel`].
