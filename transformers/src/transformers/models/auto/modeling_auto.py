...
MODEL_FOR_PRETRAINING_MAPPING_NAMES = OrderedDict(
    [
        ...
        ("sasrec", "SasrecModel"),
        ("sasrec_rope", "SasrecRoPEModel"),
        ("sasrec_gate", "SasrecGateModel"),
        ("sasrec_moe", "SasrecMoEModel"),
...
MODEL_FOR_CAUSAL_LM_MAPPING_NAMES = OrderedDict(
    [
        ...
        ("rwkv", "RwkvForCausalLM"),
        ("sasrec", "SasrecForCausalLM"),
        ("sasrec_rope", "SasrecRoPEForCausalLM"),
        ("sasrec_gate", "SasrecGateForCausalLM"),
        ("sasrec_moe", "SasrecMoEForCausalLM"),
